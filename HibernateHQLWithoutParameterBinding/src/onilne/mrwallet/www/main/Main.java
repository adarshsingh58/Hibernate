...
public class Main 
{
	...
	private static void retreiveDataIntoEntity(SessionFactory sessionFactory) {
		 ...
		 */
		/*In this case data with Id between 2 and 5 will be shown. So we have made this query a bit modifiable */
		Query query=session.createQuery(" FROM PERSON_ENTITY WHERE Id<"+5+" AND Id>"+2);
		/*
