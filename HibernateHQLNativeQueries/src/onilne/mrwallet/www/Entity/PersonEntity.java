package onilne.mrwallet.www.Entity;
...
/*
 * Difference between Named and Native Named query is that this one takes native
 * SQL query while somple named query takes HQL query. Also here we need to
 * define in which Entity class will the Result be stored into. This is done by
 * attribute resultClass
 */
@NamedNativeQuery(name="personEntityById",query="select * from person_entity where Id<?",resultClass=PersonEntity.class)
