...
/*
 * By this we can give a predefined query on ENtity itself and session can use
 * this query name to call this query directly without having to form again and
 * again
 */
@NamedQuery(name="personEntityById",query="FROM PERSON_ENTITY where Id=?")
